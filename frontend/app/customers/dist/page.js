...
function Customers() {
    ...
    function carregarClientes() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("http://localhost:3000/customer")];
                    case 1:
                        response = _a.sent();
    ...
    return (React.createElement("main", { className: "min-h-screen bg-gray-100 p-8" },
        React.createElement("div", { className: "flex justify-between items-center mb-6" },
            ...
            React.createElement("button", { className: "bg-blue-700 text-white px-5 py-3 rounded-lg" }, "+ Novo Cliente")),
        React.createElement("table", { className: "w-full bg-white rounded-xl shadow" },
            ...
            React.createElement("tbody", null, clientes.map(function (cliente) { return (React.createElement("tr", { key: cliente.id, className: "border-b text-black" },
                React.createElement("td", { className: "p-4" }, cliente.nome),
                React.createElement("td", { className: "p-4" }, cliente.email),
                React.createElement("td", { className: "p-4" }, cliente.telefone))); })))));
}
