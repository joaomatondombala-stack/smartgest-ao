...
var CustomerService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.customerRepository.save(customer)];
    ...
    CustomerService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.customerRepository.find()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    CustomerService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.customerRepository.findOne({
                            where: { id: id }
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    CustomerService.prototype.update = function (id, updateCustomerDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.customerRepository.update(id, updateCustomerDto)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.customerRepository.remove(customer)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, {
